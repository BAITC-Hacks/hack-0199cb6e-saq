...
Дополнительно обязательно опиши отдельным разделом: методологию расчёта
потребности (какие факторы учитываются и как) и алгоритм исключения
разовых крупных заказов — это отдельное требование кейса.
